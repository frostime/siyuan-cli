...
- [2026-04-17T02:42] [Correction] 配置路径统一为 `~/.config/siyuan-cli/config.yaml`，包括 Windows；`%APPDATA%` 仅作为 legacy migration source
...
- [2026-04-17T02:42] Revision: 按用户要求修正 Windows 配置路径，旧 `%APPDATA%` 配置已成功迁移到 `~/.config/siyuan-cli/config.yaml`
