...
const batchBlockItem = {
    ...
    properties: {
        data: { type: 'string' as const, description: 'Content to prepend' },
        dataType: {
...
export const schema: EndpointSchema<BlockTransaction[]> = {
    ...
    summary: 'Batch prepend blocks to parents',
    payload: {
        type: 'object',
        required: ['blocks'],
        additionalProperties: false,
...
export interface BatchPrependBlockResponse {
    code: number;
    msg: string;
