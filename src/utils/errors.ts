...
export function toCliError(e: unknown): CliError {
  ...
  if (e instanceof Error) {
    ...
    if (code === "ECONNREFUSED" || code === "ECONNRESET") {
      return new CliError(ExitCode.NETWORK, "ECONNREFUSED", msg, "Is SiYuan running?");
    }
    if (code === "ETIMEDOUT" || msg.includes("timed out")) {
      return new CliError(ExitCode.NETWORK, "ETIMEDOUT", msg, "Check your baseUrl or network.");
    }
  }
